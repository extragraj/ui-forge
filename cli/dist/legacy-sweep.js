...
const LEGACY_PATTERNS = [
    ...
    { rx: /^commands\//, reason: 'legacy-pattern: commands/ (source-bundle, lives under <scope>/commands/)' },
    { rx: /^CLAUDE\.md$/, reason: 'legacy-pattern: CLAUDE.md (contributor doc)' },
    { rx: /^LICENSE$/, reason: 'legacy-pattern: LICENSE (source-bundle metadata)' },
    { rx: /^package\.json$/, reason: 'legacy-pattern: package.json (source-bundle metadata)' },
    { rx: /^package-lock\.json$/, reason: 'legacy-pattern: package-lock.json (dev artifact)' },
    { rx: /^pnpm-lock\.yaml$/, reason: 'legacy-pattern: pnpm-lock.yaml (dev artifact)' },
    { rx: /^pnpm-workspace\.yaml$/, reason: 'legacy-pattern: pnpm-workspace.yaml (dev artifact)' },
    { rx: /^README\.md$/, reason: 'legacy-pattern: README.md (source-bundle doc)' },
    { rx: /^skill\.version$/, reason: 'legacy-pattern: skill.version (source-bundle metadata; lockfile tracks installed version)' },
    ...
    { rx: /^references\/examples\.md$/, reason: 'legacy-pattern: pre-1.7.2 examples.md (moved to examples/index.md, never shipped)' },
    { rx: /^references\/standards\//, reason: 'legacy-pattern: pre-1.6.2 standards (now in design/standards/)' },
    { rx: /^references\/docs\//, reason: 'legacy-pattern: references/docs/ (source-bundle docs, never shipped)' },
    { rx: /^references\/forgeignore\//, reason: 'legacy-pattern: references/forgeignore/ (template source, never shipped)' },
    { rx: /^references\/themes\//, reason: 'legacy-pattern: references/themes/ (theme refs source, never shipped)' },
    { rx: /^references\/themes\.md$/, reason: 'legacy-pattern: references/themes.md (source-bundle doc only)' },
    { rx: /^references\/advanced-usage\.md$/, reason: 'legacy-pattern: pre-1.7.2 doc location' },
    { rx: /^references\/migration-guide\.md$/, reason: 'legacy-pattern: pre-1.7.2 doc location' },
    { rx: /^references\/versions\.md$/, reason: 'legacy-pattern: pre-1.7.2 doc location' },
    { rx: /^references\/claude-design-handoff-format\.md$/, reason: 'legacy-pattern: pre-1.7.2 doc location' },
    { rx: /^references\/default-forgeignore\.txt$/, reason: 'legacy-pattern: pre-1.7.2 forgeignore template (now references/forgeignore/default.txt)' },
    { rx: /^references\/default-stackshift-forgeignore\.txt$/, reason: 'legacy-pattern: pre-1.7.2 stackshift forgeignore (now references/themes/stackshift/forgeignore.txt)' },
    { rx: /^references\/(?!prompt-patterns\.md$).+/, reason: 'legacy-pattern: only references/prompt-patterns.md is runtime' },
    { rx: /^themes\/README\.md$/, reason: 'legacy-pattern: themes/README.md (source-bundle doc only, moved to references/themes.md)' },
